...
The lab focused on identifying adversary tactics, techniques, and procedures (TTPs) using the MITRE ATT&CK framework and understanding how attackers progress through different stages of the cyber kill chain. Throughout the investigation, I analyzed persistence mechanisms, execution techniques, lateral movement activity, discovery actions, and potential data exfiltration methods used by advanced threat actors.
